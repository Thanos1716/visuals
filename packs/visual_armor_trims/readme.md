...
<img src="https://cdn.modrinth.com/data/tPtjib62/images/a9cabedfae562d1224422b997470b94ffda0f944.png" alt="A table displaying all of the new armor trim textures">

An example of how they compare to the entity:
...
- [CIT Resewn](https://modrinth.com/mod/cit-resewn) (requires pack version 2.1)
- [Polytone](https://modrinth.com/mod/polytone) (requires pack version 2.0)

Neither Chime nor OptiFine are officially supported.

It is still recommended to install Fabulously Optimized for 1.21.5+ for substantial performance gains, but it will no longer be necessary.

Here is a table of compatible Minecraft and mod versions.
...
On (Neo)Forge, if you want to use the CIT Resewn version, you may be able to use [Sinytra Connector](https://modrinth.com/mod/connector) or [Forge CIT](https://www.curseforge.com/minecraft/mc-mods/forge-cit), however I do not test with these configurations. Polytone should work fine with NeoForge.
